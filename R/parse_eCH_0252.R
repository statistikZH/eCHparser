...
#'
#'`parse_eCH_0252()` turns an eCH-0252 XML file into a dataframe.
#' Currently, the function supports input files generated by the
...
#' @examples
#' \dontrun{
#' votedata <- parse_eCH_0252("path/to/your/eCH-0252.xml", doi = c("CH", "CT", "MU"))
#' }
