...
The [eCH-0157 standard](https://www.ech.ch/de/ech/ech-0157) is used to import elections to and export elections from the IT systems used to manage election results management systems (i. e. VOTING in the canton of Zurich). 

The function `parse_eCH_0157()` allows users to transform these XML files to easy-to-use dataframes.

```{r example 0157, eval=FALSE}
library(eCHparser)
